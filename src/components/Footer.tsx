      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-12 border-b border-brand-border">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><a href="https://shomer-club-v2.vercel.app" target="_blank" rel="noopener noreferrer" className="text-[0.85rem] text-brand-gray-light hover:text-brand-blue transition-colors">{t("navbar.club")}</a></li>
            </ul>
          </div>
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com/shomer_arg" target="_blank" rel="noopener noreferrer" aria-label="Instagram de Shomer Security" className="w-9 h-9 border border-brand-border rounded-full flex items-center justify-center text-brand-gray hover:border-brand-blue hover:text-brand-blue transition-all">
            ...
            <a href="https://linkedin.com/in/shomerarg" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn de Shomer Security" className="w-9 h-9 border border-brand-border rounded-full flex items-center justify-center text-brand-gray hover:border-brand-blue hover:text-brand-blue transition-all">
