      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a href="https://instagram.com/shomer_arg" target="_blank" className="w-9 h-9 border border-brand-border rounded-full flex items-center justify-center text-brand-gray hover:border-brand-blue hover:text-brand-blue transition-all">
            ...
            <a href="https://linkedin.com/in/shomerarg" target="_blank" className="w-9 h-9 border border-brand-border rounded-full flex items-center justify-center text-brand-gray hover:border-brand-blue hover:text-brand-blue transition-all">
