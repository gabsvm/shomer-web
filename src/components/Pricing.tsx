  ...
  return (
    <section id="precios" className="py-24 px-6 md:px-10 bg-brand-near-black">
      <div className="max-w-[1200px] mx-auto">
        ...
        <FadeUp delay={0.4}>
          <div className="mt-20 border border-brand-border/40 rounded-lg p-8 md:p-12 bg-[linear-gradient(135deg,var(--color-brand-surface)_0%,rgba(0,191,255,0.02)_100%)] flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-[0_4px_30px_rgba(0,191,255,0.01)]">
            ...
            <div className="max-w-[650px] relative z-10">
              <div className="font-mono text-xs tracking-[0.18em] text-brand-blue uppercase mb-3">Diseño del Ecosistema</div>
              <h3 className="font-display text-2xl md:text-3xl uppercase tracking-wider mb-3 leading-none">¿Tu proyecto requiere una configuración a medida?</h3>
              <p className="text-sm text-brand-gray-light leading-relaxed font-light">
                Utilizá nuestro **Configurador 3D interactivo** más abajo para proyectar tu edificio, oficina o barrio cerrado en tiempo real con las cámaras, lectores biométricos y analíticas de inteligencia artificial necesarias.
              </p>
            </div>
            <Link
              href="#configurador"
