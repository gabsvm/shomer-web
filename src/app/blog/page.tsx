            ...
            <div className="flex flex-wrap gap-2 order-2 md:order-1">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-4 py-2 border rounded-sm text-xs font-semibold uppercase tracking-wider transition-all duration-200
          ...
          {filteredPosts.length > 0 ? (
            ...
            <div className="text-center py-20 border border-brand-border/60 rounded bg-brand-surface/20">
              ...
              <button 
                ...
                className="mt-6 font-mono text-xs tracking-wider uppercase text-brand-blue hover:text-brand-white underline"
              >
                Limpiar filtros
              </button>
            </div>
